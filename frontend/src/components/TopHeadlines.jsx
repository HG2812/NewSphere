...
function TopHeadlines() {
  ...
  useEffect(() => {
    const fetchNews = async () => {
      ...
      try {
        const response = await fetch(`https://newsapi.org/v2/top-headlines?language=en${categoryParam}&country=us&page=${page}&pageSize=${pageSize}&apiKey=b7959c3319c0476e84df4e535f957291`);
